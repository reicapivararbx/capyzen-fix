...
export const gameSaves = sqliteTable("game_saves", {
  ...
  playerName: text("playerName").default("").notNull(),
  capyName: text("capyName").default("").notNull(),
  ...
  fnfSongsCompleted: integer("fnfSongsCompleted").default(0).notNull(),
  fnfHighestCombo: integer("fnfHighestCombo").default(0).notNull(),
  millionRewardClaimed: integer("millionRewardClaimed").default(0).notNull(),
